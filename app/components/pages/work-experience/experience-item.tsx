        ...
        <div className="grid grid-cols-[40px,1fr] gap-4 md:gap-10">
            ...
            <div>
                ...
                <div className="flex flex-col gap-2 text-sm sm:text-base">
                    <a href="https://www.linkedin.com/company/workwolf"
                        target="_blank"
                    ...
                    <p className="text-gray-400">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis, a. Dolorem maiores ea alias distinctio quidem earum vitae, delectus eligendi.
                    </p>
